...
##### Singularity way
singularity -s exec -B ${OUTDATADIR}/Assembly:/INPUT -B ${OUTDATADIR}/prokka:/OUTDIR docker://quay.io/prokka:1.14.0--pl526_0 prokka --outdir /OUTDIR /INPUT/${1}_scaffolds_trimmed.fasta
