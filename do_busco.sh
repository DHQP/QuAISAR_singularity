...
##### Singularity way
singularity -s exec -B ${OUTDATADIR}/prokka:/INPUT -B ${local_DBs}/BUSCO:/DATABASES docker://quay.io/biocontainers/busco:3.0.2--py35_4 run_BUSCO.py -i /INPUT/${1}_PROKKA.faa -l /DATABASES/${2,} -m prot
