...
singularity exec -B "${OUTDATADIR}":/DATADIR -B "${local_DBs}":/DBs /apps/standalone/singularity/gottcha/gottcha.simg gottcha.pl --mode all --outdir /DATADIR/gottcha/gottcha_S --input /DATADIR/trimmed/${1}.paired.fq --database /DBs/gottcha/GOTTCHA_BACTERIA_c4937_k24_u30.species
