...
##### Singularity way
singularity exec -B ${processed}/${2}/${1}/srst2:/WDIR /apps/standalone/singularity/srst2 srst2 --input_pe /WDIR/${1}_S1_L001_R1_001.fastq.gz /WDIR/${1}_S1_L001_R2_001.fastq.gz --output /WDIR/${1}_${ResGANNCBI_srst2_filename} --gene_db ${ResGANNCBI_srst2}
