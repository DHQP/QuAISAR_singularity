...
if [[ -s "${OUTDATADIR}/plasFlow/Unicycler_assemblies/${1}_uni_assembly/${1}_plasmid_assembly_trimmed.fasta" ]]; then
	...
	singularity -s exec -B ${OUTDATADIR}/plasFlow/Unicycler_assemblies/${1}_uni_assembly:/INPUT -B ${OUTDATADIR}/Assembly_Stats_plasFlow:/OUTDIR docker://quay.io/biocontainers/quast:5.0.0--py27pl526ha92aebf_1 quast.py -o /OUTDIR /INPUT/${1}_plasmid_assembly_trimmed.fasta
