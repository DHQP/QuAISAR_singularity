...
if [[ -s "${OUTDATADIR}/plasFlow/Unicycler_assemblies/${1}_uni_assembly/${1}_plasmid_assembly_trimmed.fasta" ]]; then
	...
	singularity -s exec -B ${OUTDATADIR}/plasFlow/Unicycler_assemblies/${1}_uni_assembly:/INPUT -B ${OUTDATADIR}/Assembly_Stats_plasFlow:/OUTDIR docker://quay.io/biocontainers/quast:4.6.3--py27pl526h3727419_2 quast.py -o /OUTDIR /INPUT/${1}_plasmid_assembly_trimmed.fasta
