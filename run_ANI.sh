...
# Singularity way
singularity -s exec -B ${OUTDATADIR}/ANI/localANIDB:/INPUT -B ${OUTDATADIR}/ANI/:/OUTDIR docker://quay.io/mashtree:1.0.4--pl526h516909a_0 mashtree --numcpus ${procs} *.fasta --tempdir /OUTDIR/temp > /OUTDIR}/ANI/"${genus_in}_and_${1}_mashtree.dnd"
