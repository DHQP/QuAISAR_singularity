...
# Singularity way
singularity -s exec -B ${OUTDATADIR}/ANI/localANIDB:/INPUT -B ${OUTDATADIR}/ANI/:/OUTDIR docker://quay.io/mashtree:0.20--pl5.22.0_0 mashtree --numcpus ${procs} /INPUT/*.fasta --outtree /OUTDIR/"${genus_in}_and_${1}_mashtree.dnd"
