...
singularities=(cSSTAR.simg+${cSSTAR_links[${link_index}]}+688 entrez_taxon.simg+${entrez_links[${link_index}]}+239 plasmidFinder_with_DB.simg+${plasmidFinder_links[${link_index}]}+805)
